...
**3. The direct economy relocates inequality rather than reducing it.** It preserves the upper tail exactly and adds a mass of artists earning literally zero: at the calibrated superfan share, 75% of artists get nothing from direct payments. Gini barely moves (0.972 → 0.974); its composition changes completely.
