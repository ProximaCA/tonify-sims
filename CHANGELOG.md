...
## unreleased — emp1: reduced-form slope b, the dispute's first measured number (2026-08-15)

- **emp1/** — первое эмпирическое измерение сопряжения интенсивности с
  размером аудитории (прокси γ из sim4(c)) по открытым логам Last.fm
