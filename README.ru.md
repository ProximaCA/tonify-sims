...
месяц на подписанном pro-rata стриминговом контракте, — или 3 204 слушателя
на прямой рельсе, где ~54 суперфана из них (1,7%) донатят четыре раза в год. В этом репозитории — три
...
перечислены в [CRITIC](paper/CRITIC.ru.md) (sim1) и
CHANGELOG-блоках спек ([SPEC sim2](sim2/SPEC.md),
[SPEC sim3](sim3/SPEC.md)).
